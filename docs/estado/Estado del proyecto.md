...
**Actualizado**: 2026-08-01 · rama activa `desktop-tauri`
...
4. **Reflejar a web** lo que corresponda de la línea de IA: por naturaleza, poco o nada
   (ver [[Diferencias funcionales aceptadas entre versiones]]).
5. **Backlog de funcionalidades**: [[BACKLOG]] tiene el inventario completo con tamaños
...
6. **`FUN-L-09`** — servidor MCP de Mycelium, el paso siguiente de la línea de IA.
7. **Continuaciones de `FUN-M-12`**: `FUN-M-14` (reindex dirigido por el watcher, el más
