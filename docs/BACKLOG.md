...
| `FUN-M-32` 🟢 | `UI-CONFIGURACION` | **Configuración** deja de ser un panel de 440px que entra desde la derecha y pasa a una **ventana centrada** (980×700) con las categorías a la izquierda —Aspecto, Trabajo, Vault, Sistema— y un **buscador de ajustes** que salta al ajuste y lo señala. Las opciones son las mismas; lo que cambia es dónde viven y cuánto sitio tienen. Los controles se acotan para que un desplegable no mida 700px. **Implementado en `experimento/ui-impeccable` el 2026-09-20**, sin confirmar en la app. Spec en [[configuracion]] | desktop | — |
