...
| `FUN-L-11` | `FILES-OTROS-TIPOS` | **Abrir** los archivos que no son notas —texto, código, PDF e imágenes— en un visor propio, como una pestaña más. La mitad de *aparecer en el explorador* ya la resolvió `FUN-S-03`. **De solo lectura** y **solo-desktop**: en web esos archivos no existen en ninguna parte. Spec en [[otros-tipos-de-archivo]] | desktop | — |
