...
| DEF-078 | Las opciones de un desplegable van pegadas al borde de la lista | ambas (frontend) | 🛠️ desktop (2026-09-04) — faltaba el `padding` en `select option`; **sin confirmar** |
