...
| DEF-090 | La búsqueda de la barra superior no busca: se escribe y no pasa nada | ambas (frontend) | ⏳ pendiente (registrado 2026-09-19) — antes de arreglarlo hay que decidir qué es el campo: atajo a la búsqueda global, paleta de comandos, o quitarlo |
