...
export function EditorSection() {
  ...
  return (
    <div>
      ...
      />
      <p className={styles.hint}>
        {/* En desktop la lista incluye la consola y los archivos que Mycelium
            no indexa; acá no existe ninguno de los dos. */}
        Junto al nombre, el ícono del tipo de documento: nota, dibujo, lienzo o
        tabla. Apagalo si preferís que el título ocupe todo el ancho de la
        pestaña.
      </p>
