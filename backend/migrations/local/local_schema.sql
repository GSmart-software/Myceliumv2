-- Esquema local SQLite (HU-39). Lo ejecuta LocalDbInitializer en el arranque
-- cuando Storage:Provider=local. Idempotente: todo es CREATE ... IF NOT EXISTS.
-- La base (micelio.local.db) es desechable: borrarla reinicia el estado limpio.
